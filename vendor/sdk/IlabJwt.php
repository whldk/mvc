...
class IlabJwt
{
	...
	protected static $secretKey = 'pa8npj';
	protected static $aesKey = 'M6RyVwTv9K/o+iLKb4+H+AMQh6+e4qnGAcPmk7nSq2I=';
	...
	protected static function encrypt($body)
	{
		...
		//补齐为64字节的整数倍
		$tempLen = strlen($payload);
		$paddingLen= 16 - $tempLen % 16;
		$padding = str_pad('', $paddingLen, pack('c', $paddingLen - 1));
		$payload .= $padding;
