...
class RequestCore
{
	 ...
	 */
	public $request_class = '\vendor\sdk\RequestCore';

	/**
	 * The default class to use for HTTP Responses (defaults to <ResponseCore>).
	 */
	public $response_class = '\vendor\sdk\ResponseCore';
	 ...
	 *
	 * @param string|array $body (Required) The content to send along in the body of the request.
	 * @return $this A reference to the current instance.
	 */
