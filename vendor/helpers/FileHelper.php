...
class FileHelper
{
	public static $mimeMagicFile = DIR_APP. '/vendor/base/mimeTypes.php';
	...
	public static function getMimeType($file, $magicFile = null, $checkExtension = true)
	{
		...
		return $checkExtension ? static::getMimeTypeByExtension($file, $magicFile) : '';
	}
	 ...
	 * @return string the MIME type. Emptry string is returned if the MIME type cannot be determined.
	 */
	...
	*/
	...
	public static function unlink(string $file, $glob = false)
	{
		if ($glob) {
			if ($files = glob($file)) {
				array_map('unlink', array_map('realpath', $files));
			}
		} else {
			unlink($file);
		}
